        ...
        <body className="admin-body">
            ...
            <section class="home">
                ...
                <div class="home-wrapper">
                    <button className="create-account" onClick={() => window.location.href = "admin-check-account"}>Check Accounts</button>
                    <button className="create-account"onClick={() => window.location.href = "create-unit"}>Create Unit Account</button>
                    <button className="create-account"onClick={() => window.location.href = "create-police"}>Create Police Account</button>
                </div>
        </div>
            </section>
        </body>
