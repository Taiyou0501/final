            ...
            <section className="home">
                ...
                <div className="home-wrapper">
                            <div className="profile-info"> Account Details
                                ...
                                <div className="subtext">unit.unit@gmail.com</div>
                                <div className="title">Password: </div>
                                <div className="subtext">*************</div>
                                <div className="title">Role: </div>
                                <div className="subtext">Head Chief</div>
                                <button className="edit-account" onClick={() => window.location.href = "unit-edit-account"}>Edit Account</button>
                                </div>
                            </div>
                </div>
                </div>
